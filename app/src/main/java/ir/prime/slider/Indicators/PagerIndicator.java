package ir.prime.slider.Indicators;
...
public class PagerIndicator extends LinearLayout implements ViewPager.OnPageChangeListener,ViewPagerEx.OnPageChangeListener{

    private Context mContext;

    /**
     * bind this Indicator with {@link ir.prime.slider.Tricks.ViewPagerEx}
     */
    ...
    /**
     *This value is from {@link ir.prime.slider.SliderAdapter} getRealCount() represent
     *
    ...
    public void setViewPager(ViewPager pager){
        ...
        ((PagerAdapter)mPager.getAdapter()).registerDataSetObserver(dataChangeObserver);
    }
