package ir.prime.slider.Transformers;
 ...
 *
 * BaseTransformer implement {@link ir.prime.slider.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link ir.prime.slider.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link ir.prime.slider.Animations.BaseAnimationInterface}
 * work.
 *
