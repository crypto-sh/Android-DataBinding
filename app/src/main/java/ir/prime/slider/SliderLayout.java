...
import ir.prime.R;
import ir.prime.slider.Animations.BaseAnimationInterface;
import ir.prime.slider.Indicators.PagerIndicator;
import ir.prime.slider.SliderTypes.BaseSliderView;
import ir.prime.slider.Transformers.BaseTransformer;
import ir.prime.slider.Transformers.DefaultTransformer;
import ir.prime.slider.Transformers.ZoomOutTransformer;
import ir.prime.slider.Tricks.FixedSpeedScroller;
import ir.prime.slider.Tricks.InfinitePagerAdapter;
import ir.prime.slider.Tricks.InfiniteViewPager;
import ir.prime.slider.Tricks.ViewPagerEx;
...
/**
 * SliderLayout is compound layout. This is combined with {@link ir.prime.slider.Indicators.PagerIndicator}
 * and {@link ir.prime.slider.Tricks.ViewPagerEx} .
 *
...
public class SliderLayout extends RelativeLayout {
    ...
    /**
     * {@link ir.prime.slider.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link ir.prime.slider.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link ir.prime.slider.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link ir.prime.slider.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link ir.prime.slider.Tricks.ViewPagerEx}
     */
    private boolean mAutoRecover = true;


    /**
     * {@link ir.prime.slider.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link ir.prime.slider.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link ir.prime.slider.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see ir.prime.slider.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link ir.prime.slider.Indicators.PagerIndicator} shape, rect or oval.
     */
