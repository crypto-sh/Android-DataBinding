 ...
 */
package ir.prime.primevideo.exoplayer2.offline;

import android.support.annotation.Nullable;

import ir.prime.primevideo.exoplayer2.C;
import ir.prime.primevideo.exoplayer2.upstream.DataSink;
import ir.prime.primevideo.exoplayer2.upstream.DataSource;
import ir.prime.primevideo.exoplayer2.upstream.DataSource.Factory;
import ir.prime.primevideo.exoplayer2.upstream.DummyDataSource;
import ir.prime.primevideo.exoplayer2.upstream.FileDataSource;
import ir.prime.primevideo.exoplayer2.upstream.PriorityDataSource;
import ir.prime.primevideo.exoplayer2.upstream.cache.Cache;
import ir.prime.primevideo.exoplayer2.upstream.cache.CacheDataSink;
import ir.prime.primevideo.exoplayer2.upstream.cache.CacheDataSource;
import ir.prime.primevideo.exoplayer2.util.Assertions;
import ir.prime.primevideo.exoplayer2.util.PriorityTaskManager;
