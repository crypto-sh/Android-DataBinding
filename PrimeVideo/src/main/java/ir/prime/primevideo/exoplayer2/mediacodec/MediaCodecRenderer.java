 ...
 */
package ir.prime.primevideo.exoplayer2.mediacodec;
...
import ir.prime.primevideo.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException;
...
public abstract class MediaCodecRenderer extends BaseRenderer {
  ...
  public static class DecoderInitializationException extends Exception {
    ...
    private static String buildCustomDiagnosticInfo(int errorCode) {
      ...
      return "ir.primevideo.exoplayer.MediaCodecTrackRenderer_" + sign + Math.abs(errorCode);
    }
