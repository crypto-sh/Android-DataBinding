 ...
 */
package ir.prime.primevideo.exoplayer2.extractor;

import java.lang.reflect.Constructor;

import ir.prime.primevideo.exoplayer2.extractor.flv.FlvExtractor;
import ir.prime.primevideo.exoplayer2.extractor.mkv.MatroskaExtractor;
import ir.prime.primevideo.exoplayer2.extractor.mp3.Mp3Extractor;
import ir.prime.primevideo.exoplayer2.extractor.mp4.FragmentedMp4Extractor;
import ir.prime.primevideo.exoplayer2.extractor.mp4.Mp4Extractor;
import ir.prime.primevideo.exoplayer2.extractor.ogg.OggExtractor;
import ir.prime.primevideo.exoplayer2.extractor.ts.Ac3Extractor;
import ir.prime.primevideo.exoplayer2.extractor.ts.AdtsExtractor;
import ir.prime.primevideo.exoplayer2.extractor.ts.DefaultTsPayloadReaderFactory;
import ir.prime.primevideo.exoplayer2.extractor.ts.PsExtractor;
import ir.prime.primevideo.exoplayer2.extractor.ts.TsExtractor;
import ir.prime.primevideo.exoplayer2.extractor.ts.TsPayloadReader;
import ir.prime.primevideo.exoplayer2.extractor.wav.WavExtractor;
  ...
  static {
    ...
    try {
      flacExtractorConstructor =
          Class.forName("ir.prime.primevideo.exoplayer2.ext.flac.FlacExtractor")
