 ...
 */
package ir.prime.primevideo.exoplayer2.ext.mediasession;
...
public final class RepeatModeActionProvider implements MediaSessionConnector.CustomActionProvider {
    ...
    public RepeatModeActionProvider(Context context, Player player,
        ...
        repeatAllDescription = context.getString(R.string.exo_controls_repeat_all_description);
        repeatOneDescription = context.getString(R.string.exo_controls_repeat_one_description);
        repeatOffDescription = context.getString(R.string.exo_controls_repeat_off_description);
    }
    ...
    public PlaybackStateCompat.CustomAction getCustomAction() {
        ...
        switch (player.getRepeatMode()) {
            case Player.REPEAT_MODE_ONE:
                ...
                iconResourceId = R.drawable.exo_controls_repeat_one;
                break;
            case Player.REPEAT_MODE_ALL:
                actionLabel = repeatAllDescription;
                iconResourceId = R.drawable.exo_controls_repeat_all;
                break;
            case Player.REPEAT_MODE_OFF:
            default:
                actionLabel = repeatOffDescription;
                iconResourceId = R.drawable.exo_controls_repeat_off;
                break;
        }
