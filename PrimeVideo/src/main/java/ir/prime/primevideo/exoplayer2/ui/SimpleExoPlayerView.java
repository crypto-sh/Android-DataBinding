...
import ir.prime.primevideo.exoplayer2.ControlDispatcher;
import ir.prime.primevideo.exoplayer2.DefaultControlDispatcher;
import ir.prime.primevideo.exoplayer2.Player;
import ir.prime.primevideo.exoplayer2.Player.DiscontinuityReason;
import ir.prime.primevideo.exoplayer2.SimpleExoPlayer;
import ir.prime.primevideo.exoplayer2.metadata.Metadata;
import ir.prime.primevideo.exoplayer2.metadata.id3.ApicFrame;
import ir.prime.primevideo.exoplayer2.source.TrackGroupArray;
import ir.prime.primevideo.exoplayer2.text.Cue;
...
import ir.prime.primevideo.exoplayer2.ui.AspectRatioFrameLayout.ResizeMode;
...
public final class SimpleExoPlayerView extends FrameLayout {
    ...
    final String TAG = SimpleExoPlayerView.class.getSimpleName();
    ...
    public boolean onTouchEvent(MotionEvent event) {
        PublicFunction.LogData(true,TAG,"SimpleExoPlayerView Touch Handler");
        if (!useController || player == null || event.getActionMasked() != MotionEvent.ACTION_DOWN) {
            return false;
        }
//        if (!controller.isVisible()) {
//            maybeShowController(true);
//            PublicFunction.LogData(true, TAG, event.getActionMasked() + " show ");
//        } else if (controllerHideOnTouch) {
//            controller.hide();
//            PublicFunction.LogData(true, TAG, event.getActionMasked() + " hide ");
//        }
        return true;
    }
